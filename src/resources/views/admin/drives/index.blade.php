...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h3 class="m-0 font-weight-bold text-primary">@lang('manage-drives')</h3>
    </div>
    <!-- Button Add  -->
    <div>
        <div class=" p-3 pt-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table class="table table-bordered datatable-drive " width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th width="5%">@lang('drive-id')</th>
                        <th width="5%">@lang('drive-logo')</th>
                        <th width="35%">@lang('drive-name')</th>
                        <th width="10%">@lang('drive-actions')</th>
                    </tr>
                </thead>
            </table>
        </div>
            ...
            <form method="post" id="sample_form" class="" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">@lang('drive-name'):</label>
                        <input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp" placeholder="@lang('drive-name')">
                        <!-- <small id="nameHelp" class="form-text text-muted">Your information is safe with us.</small> -->
                    </div>
                    <!-- Logo Input and Preview-->
                    <div class="form-group">
                        <label for="logo">@lang('drive-logo'):</label>
