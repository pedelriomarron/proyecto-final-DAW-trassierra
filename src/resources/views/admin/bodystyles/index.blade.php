...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#create_record').click(function() {
            ...
            $('#action').val('Add');
            $('#form_result').html('');
            $("#logo_preview").attr("src", "{{ asset('uploads/bodystyles/') }}" + "/default.png");
        ...
        $('#sample_form').on('submit', function(event) {
            ...
            if ($('#action').val() == 'Add') {
                action_url = "{{ route('bodystyles.store') }}";
            }

            if ($('#action').val() == 'Edit') {
                action_url = "{{ route('bodystyles.update') }}";
            }
            // Ajax send form
            $.ajax({
                url: action_url,
        ...
        $(document).on('click', '.edit', function() {
            var id = $(this).attr('id');
            $('#form_result').html('');
            var url = '{{ route("bodystyles.edit", ":id") }}';
        ...
        $('#ok_button').click(function() {
            var url = '{{ route("bodystyles.deletebyid", ":id") }}';
