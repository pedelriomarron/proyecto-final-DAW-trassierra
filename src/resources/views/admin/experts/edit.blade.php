...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h3 class="m-0 font-weight-bold text-primary">@lang('Edit Administrator')</h3>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-lg-12 margin-tb pb-5">
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('experts.index') }}"> @lang('Back')</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-group"><strong>@lang('concessionaire'):</strong>
                    <input placeholder="Name" name="name_show" type="text" class="form-control"
                        value="{{$concessionaire->name_show}}">
                </div>
                <div class="form-group"><strong>@lang('URL'):</strong>
                    <input placeholder="Url" name="url_show" type="text" class="form-control"
                        value="{{$concessionaire->url_show}}">
                </div>
            </div>
